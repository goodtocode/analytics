...
{
    public class LinkDataSourceMultipleByGroupActivity<TDataSource> where TDataSource : class, IEntity, new()
    {
        ...
        public LinkDataSourceMultipleByGroupActivity(IEnumerable<string> ruleGroupPartitions)
        {
        ...
        {
            var linkWorkflow = new LinkDataSourceMultipleActivity<TDataSource>();
