...
{
    public class LinkDataSourceSequentialByGroupActivity<TDataSource> where TDataSource : class, IEntity, new()
    {
        ...
        public LinkDataSourceSequentialByGroupActivity(IEnumerable<string> ruleGroupPartitions)
        {
        ...
        {
            var linkWorkflow = new LinkDataSourceSequentialActivity<TDataSource>();
